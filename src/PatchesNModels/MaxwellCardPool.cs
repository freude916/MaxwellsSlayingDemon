...
namespace MaxwellsSlayingDemon.PatchesNModels;
...
public class MaxwellCardPool : CustomCardPoolModel
{
    ...
    /// 大能量图标路径
    /// </summary>
    public override string? BigEnergyIconPath => "res://MaxwellsSlayingDemon/images/ui/cardOrb.png";
    
    /// <summary>
    /// 文本能量图标路径
    /// </summary>
    public override string? TextEnergyIconPath => "res://MaxwellsSlayingDemon/images/ui/energyOrb-lighter.png";
